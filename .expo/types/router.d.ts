...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/attendences/` | `/attendences/RegisterAttendance` | `/attendences/UpdateAttendance` | `/auth/` | `/auth/register` | `/auth/reset-password` | `/doctors/` | `/doctors/register` | `/doctors/update` | `/home/HomeScreen` | `/home/` | `/hooks/useAuth` | `/patients/CadastroPaciente` | `/patients/` | `/patients/PacienteDetails` | `/screens/aconselhar_alimentacao/` | `/screens/aidpi_neonatal/` | `/screens/graficos/graficos_meninas_0a2/` | `/screens/graficos/graficos_meninas_2a5/` | `/screens/graficos/graficos_meninos_0a2/` | `/screens/graficos/graficos_meninos_2a5/` | `/screens/procedimentos/artemeter_malaria/` | `/SplashScreen` | `/styles/AuthStyles` | `/styles/CadastroPacienteStyles` | `/styles/HomeScreenStyles` | `/styles/LoadingOverlayStyles` | `/styles/PacienteDetailsStyles` | `/styles/Styles` | `/styles/VaccinationStyles` | `/vaccines/` | `/vaccines/RegisterVaccination` | `/vaccines/UpdateVaccine` | `/screens/aconselhamentos/aconselhar_alimentacao/` | `/screens/graficos/` | `/screens/medicamentos/` | `/screens/planos/` | `/screens/procedimentos/` | `/screens/tabelas/` | `/screens/vacinacao/` | `/screens/vitaminas/` | `/screens/aconselhamentos/` | `/screens/aconselhamentos/aconselhar_mae/` | `/screens/aconselhamentos/avaliar_alimentação/`;
  // prettier-ignore
