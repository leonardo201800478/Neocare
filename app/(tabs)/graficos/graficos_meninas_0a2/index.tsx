...
export default function GraficosMeninas0a2() {
      ...
      <GestureHandlerRootView style={styles.container}>
        ...
        <ScrollView
          ...
          <ScrollView contentContainerStyle={styles.scrollContainer} bounces={false}>
            <PinchGestureHandler onGestureEvent={handlePinchEvent}>
              <View style={styles.imageContainer}>
                <Image
                  source={require('../assets/graficos/menina0-2.jpg')}
                  style={[styles.image, { transform: [{ scale }] }]}
                />
                <Image
                  source={require('../assets/graficos/menina0-2_2.jpg')}
                  style={[styles.image, { transform: [{ scale }] }]}
                />
                <Image
                  source={require('../assets/graficos/menina0-2_3.jpg')}
                  style={[styles.image, { transform: [{ scale }] }]}
                />
                <Image
