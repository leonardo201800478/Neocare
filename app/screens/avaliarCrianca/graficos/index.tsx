    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <TouchableOpacity
          ...
          <Text style={styles.buttonText}>Gráficos meninas de 0 a 2 meses</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.sectionButtonMenina}
          onPress={() => router.push('/screens/aidpiNeonatal/graficos/graficos_meninas_2a5/')}>
          <Text style={styles.buttonText}>Gráficos meninas de 2 a 5 anos</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.sectionButtonMenino}
          onPress={() => router.push('/screens/aidpiNeonatal/graficos/graficos_meninos_0a2/')}>
          <Text style={styles.buttonText}>Gráficos meninos de 0 a 2 meses</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.sectionButtonMenino}
          onPress={() => router.push('/screens/aidpiNeonatal/graficos/graficos_meninos_2a5/')}>
          <Text style={styles.buttonText}>Gráficos meninos de 2 a 5 anos</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
